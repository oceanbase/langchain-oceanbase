...
class TestHybridSearch:
    ...
    def sample_documents(self):
        ...
        return [
            ...
            Document(
                ...
                metadata={"topic": "Programming", "author": "Charlie Davis", "year": 2024}
            ),
        ]
    ...
    def test_add_sparse_documents(self, hybrid_vectorstore):
        ...
        documents = [
            Document(page_content="Machine learning algorithms", metadata={"topic": "AI"}),
    ...
    def test_add_documents_with_fulltext(self, hybrid_vectorstore):
        ...
        documents = [
            Document(page_content="Python programming", metadata={"language": "Python"}),
            Document(page_content="JavaScript development", metadata={"language": "JavaScript"}),
        ]
    ...
    def test_advanced_hybrid_search_vector_only(self, hybrid_vectorstore):
        ...
        documents = [
            Document(page_content="AI and machine learning research", metadata={"category": "AI"}),
            Document(page_content="Deep learning neural networks", metadata={"category": "AI"}),
        ]
    ...
    def test_error_handling_no_search_modality(self, hybrid_vectorstore):
        ...
        with pytest.raises(ValueError, match="At least one search modality must be provided"):
    ...
    def test_comprehensive_hybrid_search_workflow(self, hybrid_vectorstore, sample_documents, 
                                                sample_sparse_embeddings, sample_fulltext_content):
    ...
    def test_result_fusion_algorithm_validation(self, hybrid_vectorstore, sample_documents, 
                                              sample_sparse_embeddings, sample_fulltext_content):
    ...
    def test_edge_cases_and_boundary_conditions(self, hybrid_vectorstore):
        ...
        special_doc = Document(
            ...
            metadata={"special": "测试中文", "unicode": "🚀", "json": '{"key": "value"}'}
        )
    ...
    def test_metadata_filtering_integration(self, hybrid_vectorstore, sample_documents, 
    ...
    def test_concurrent_search_operations(self, hybrid_vectorstore, sample_documents, 
                                        sample_sparse_embeddings, sample_fulltext_content):
    ...
    def test_advanced_hybrid_search_with_custom_weights(self, hybrid_vectorstore, sample_documents, 
                                                      sample_sparse_embeddings, sample_fulltext_content):
    ...
    def test_advanced_hybrid_search_weight_validation(self, hybrid_vectorstore):
        ...
        with pytest.raises(ValueError, match="Modality weights must sum to 1.0"):
            hybrid_vectorstore.advanced_hybrid_search(
                vector_query="test",
                modality_weights={'vector': 0.5, 'sparse': 0.3, 'fulltext': 0.1}  # Sum = 0.9
            )
        ...
        try:
            results = hybrid_vectorstore.advanced_hybrid_search(
                vector_query="test",
                modality_weights=valid_weights
            )
    ...
    def test_advanced_hybrid_search_partial_weights(self, hybrid_vectorstore, sample_documents):
        ...
        results = hybrid_vectorstore.advanced_hybrid_search(
            vector_query="machine learning",
            k=3,
            modality_weights=partial_weights
        )
    ...
    def test_integration_with_real_world_scenarios(self, hybrid_vectorstore):
        ...
        results = hybrid_vectorstore.similarity_search_with_fulltext(
            ...
            fulltext_query="attention mechanism",
            k=2
        )
        ...
        results = hybrid_vectorstore.similarity_search_with_fulltext(
            ...
            fulltext_query="bluetooth headphones",
            k=2
        )
